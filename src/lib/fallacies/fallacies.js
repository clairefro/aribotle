export default [
  {
    ...
    "description": "An argument that tries to persuade the audience by appealing to their emotions rather than by providing logical evidence."
  },
  {
    "name": "fallacy of credibility",
    "description": "An argument that attacks the credibility of the person making the argument, rather than the argument itself."
  },
  {
    "name": "circular reasoning",
    "description": "An argument that assumes the conclusion in its premises."
  },
  {
    "name": "fallacy of relevance",
    "description": "An argument that contains irrelevant information."
  },
  {
    "name": "ad populum",
    "description": "An argument that appeals to the majority opinion."
  },
  {
    "name": "false dilemma",
  ...
  {
    "name": "equivocation",
    "description": "An argument that uses a word or phrase with two different meanings."
  },
  {
    "name": "fallacy of logic",
    "description": "An argument that contains a logical error."
  },
  {
    "name": "false causality",
    "description": "An argument that assumes that one event causes another event, when there is no evidence to support this claim."
  },
  {
    "name": "red herring",
    "description": "An argument that introduces irrelevant information in order to distract the audience from the main point."
  },
  {
    "name": "straw man",
    "description": "An argument that misrepresents the opponent's position in order to make it easier to attack."
  },
  {
    "name": "ad hominem",
    "description": "An argument that attacks the person making the argument, rather than the argument itself."
  },
  {
    "name": "tu quoque",
    "description": "An ad hominem argument that accuses the other person of hypocrisy."
  },
  {
    "name": "appeal to ignorance",
    "description": "An argument that asserts that something is true because it has not been proven false."
  },
  {
  ...
  },
  {
    ...
    "description": "An argument that asserts that something is true because it has been done that way for a long time."
  },
  {
  ...
  },
  {
    ...
    "description": "An argument that judges something based on its origins, rather than its merits."
  },
  {
    "name": "non sequitur",
    "description": "An argument that does not follow logically from its premises."
  },
  {
    "name": "slippery slope",
    "description": "An argument that asserts that if one thing happens, then it will inevitably lead to a series of bad consequences."
  },
  {
    "name": "false analogy",
    "description": "An argument that draws a comparison between two things that are not similar in all relevant respects."
  },
  {
    "name": "fallacy of composition",
    "description": "An argument that assumes that what is true for the parts of something is also true for the whole thing."
  },
  {
    "name": "fallacy of division",
    "description": "An argument that assumes that what is true for the whole of something is also true for the parts."
  },
  {
    "name": "loaded question",
    "description": "A question that is phrased in such a way that the answer is biased in favor of one side of an argument."
  },
  {
